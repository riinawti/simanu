                            ...
                            <tbody>
                                ...
                                foreach ($data as $item) : ?>
                                    <tr>
                                        ...
                                        <td><?= $item['alamat'] ?></td>
                                        <td>
                                            <a href="<?= base_url('suplier/edit/' . $item['id_suplier']) ?>" class="badge bg-warning"><i class="fas fa-pen"></i> Edit</a>
                                            <a href="<?= base_url('suplier/delete/' . $item['id_suplier']) ?>" class="badge bg-danger" onclick="return confirm('yakin untuk menghapus?')"><i class="fas fa-trash"></i> Hapus</a>
                                        </td>
                                    </tr>
                                <?php endforeach ?>
                            </tbody>
