                    ...
                    <div class="card-body p-4">
                        <form action="<?= base_url('suplier/update') ?>" method="post">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10"> <input type="text" class="form-control <?= form_error('kode') ? 'is-invalid' : '' ?>" id="inputText" name="kode" value="<?= $data['kode'] ?>"></div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10"> <input type="text" class="form-control <?= form_error('sales') ? 'is-invalid' : '' ?>" id="inputText" name="sales" value="<?= $data['sales'] ?>"></div>
                                <div class="invalid-feedback">
                                    <?= form_error('sales'); ?>
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10"> <input type="text" class="form-control <?= form_error('telepon') ? 'is-invalid' : '' ?>" id="inputText" name="telepon" value="<?= $data['telepon'] ?>"></div>
                                <div class="invalid-feedback">
                                    <?= form_error('telepon'); ?>
                                </div>
                            </div>
