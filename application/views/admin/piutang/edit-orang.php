                ...
                <div class="card">
                    ...
                    <div class="card-body p-4">
                        <form action="<?= base_url('piutang/updateOrang') ?>" method="post" enctype="multipart/form-data">
                            <input type="hidden" name="id" value="<?= $data['id_oh'] ?>">
                            <input type="hidden" name="ktp_lama" value="<?= $data['ktp'] ?>">
                            <div class="row mb-3">
                                <label for="inputEmail3" class="col-sm-2 col-form-label">NIK</label>
                                <div class="col-sm-10"> <input type="text" class="form-control <?= form_error('nik') ? 'is-invalid' : '' ?>" id="inputText" name="nik" value="<?= $data['nik'] ?>"></div>
